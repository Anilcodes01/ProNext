...
export default function Home() {
  ...
  return (
    <div className="h-screen hide-scrollbar overflow-auto">
      {/* Fixed navbar */}
      <motion.nav
        initial={{ y: -50, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.5 }}
        className="fixed top-0 w-full z-50 h-16 text-black flex items-center justify-between border-b bg-white/90 backdrop-blur-sm"
      >
      ...
      <main className="pt-16 bg-white">
        ...
        <motion.div
          ...
          className="bg-gradient-to-b from-sky-100 to-white min-h-screen flex justify-center items-center px-4 md:px-8"
        >
